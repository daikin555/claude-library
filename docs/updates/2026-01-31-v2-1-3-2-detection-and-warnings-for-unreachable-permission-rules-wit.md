---
title: "追加 detection and warnings for unreachable permission rule..."
date: 2026-01-09
tags: ['新機能', 'パーミッション']
---
...
追加 detection and warnings for unreachable permission rules, with warnings in `/doctor` and after saving rules that include the source of each rule and actionable fix guidance
