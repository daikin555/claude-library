---
title: "修正 a race condition where stale OAuth tokens could be rea..."
date: 2026-01-07
tags: ['バグ修正']
---
...
修正 a race condition where stale OAuth tokens could be read from the keychain cache during concurrent token refresh attempts
