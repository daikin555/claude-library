---
title: "修正 PreToolUse hooks to allow `updatedInput` when returnin..."
date: 2026-01-07
tags: ['バグ修正', 'hooks', 'パーミッション']
---

## 原文（日本語に翻訳）

修正 PreToolUse hooks to allow `updatedInput` when returning `ask` permission decision, enabling hooks to act as middleware while still requesting user consent
