---
title: "改善 permission explainer to not flag routine dev workflows..."
date: 2026-01-09
tags: ['改善', 'パーミッション']
---
...
改善 permission explainer to not flag routine dev workflows (git fetch/rebase, npm install, tests, PRs) as medium risk
