---
title: "変更 the `/commit-push-pr` skill to automatically post PR U..."
date: 2026-01-27
tags: ['変更', 'MCP']
---
...
変更 the `/commit-push-pr` skill to automatically post PR URLs to Slack channels when configured via MCP tools
