---
title: "追加 `FORCE_AUTOUPDATE_PLUGINS` environment variable to all..."
date: 2026-01-09
tags: ['新機能']
---
...
追加 `FORCE_AUTOUPDATE_PLUGINS` environment variable to allow plugin autoupdate even when the main auto-updater is disabled
