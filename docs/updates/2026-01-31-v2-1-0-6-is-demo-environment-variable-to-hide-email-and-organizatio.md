---
title: "追加 `IS_DEMO` environment variable to hide email and organ..."
date: 2026-01-07
tags: ['新機能']
---
...
追加 `IS_DEMO` environment variable to hide email and organization from the UI, useful for streaming or recording sessions
