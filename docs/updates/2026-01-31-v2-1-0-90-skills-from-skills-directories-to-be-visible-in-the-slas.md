---
title: "改善 skills from `/skills/` directories to be visible in th..."
date: 2026-01-07
tags: ['改善', 'コマンド']
---
...
改善 skills from `/skills/` directories to be visible in the slash command menu by default (opt-out with `user-invocable: false` in frontmatter)
