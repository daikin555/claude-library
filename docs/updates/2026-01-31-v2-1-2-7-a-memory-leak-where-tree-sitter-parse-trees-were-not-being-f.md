---
title: "修正 a memory leak where tree-sitter parse trees were not b..."
date: 2026-01-09
tags: ['バグ修正']
---
...
修正 a memory leak where tree-sitter parse trees were not being freed, causing WASM memory to grow unbounded over long sessions
