---
title: "追加 `--tools` flag support in interactive mode to restrict..."
date: 2026-01-31
tags: ['新機能']
---
...
追加 `--tools` flag support in interactive mode to restrict which built-in tools Claude can use during interactive sessions
