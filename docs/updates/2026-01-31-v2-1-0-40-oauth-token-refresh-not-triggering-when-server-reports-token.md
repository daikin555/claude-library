---
title: "修正 OAuth token refresh not triggering when server reports..."
date: 2026-01-07
tags: ['バグ修正']
---
...
修正 OAuth token refresh not triggering when server reports token expired but local expiration check disagrees
