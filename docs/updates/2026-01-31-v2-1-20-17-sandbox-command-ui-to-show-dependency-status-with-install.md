---
title: "改善 `/sandbox` command UI to show dependency status with i..."
date: 2026-01-27
tags: ['改善', 'コマンド']
---
...
改善 `/sandbox` command UI to show dependency status with installation instructions when dependencies are missing
