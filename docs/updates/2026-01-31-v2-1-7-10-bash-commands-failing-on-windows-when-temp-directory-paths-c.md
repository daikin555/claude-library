---
title: "修正 bash commands failing on Windows when temp directory p..."
date: 2026-01-14
...
修正 bash commands failing on Windows when temp directory paths contained characters like `t` or `n` that were misinterpreted as escape sequences
