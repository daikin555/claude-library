---
title: "修正 API context overflow when background tasks produce lar..."
date: 2026-01-07
tags: ['バグ修正']
---
...
修正 API context overflow when background tasks produce large output by truncating to 30K chars with file path reference
