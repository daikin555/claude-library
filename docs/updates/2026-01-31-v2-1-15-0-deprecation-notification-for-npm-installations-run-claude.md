---
title: "追加 deprecation notification for npm installations - run `..."
date: 2026-01-21
tags: ['新機能']
---
...
追加 deprecation notification for npm installations - run `claude install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options
