...
修正 "Help improve Claude" setting fetch to refresh OAuth and retry when it fails due to a stale OAuth token
...
Claude Code v2.1.4 でリリースされた機能です。
...
- この機能は Claude Code v2.1.4 で導入されました
