---
title: "追加 `CLAUDE_CODE_FILE_READ_MAX_OUTPUT_TOKENS` environment ..."
date: 2026-01-07
tags: ['新機能']
---
...
追加 `CLAUDE_CODE_FILE_READ_MAX_OUTPUT_TOKENS` environment variable to override the default file read token limit
