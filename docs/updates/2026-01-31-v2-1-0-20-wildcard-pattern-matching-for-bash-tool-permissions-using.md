---
title: "追加 wildcard pattern matching for Bash tool permissions us..."
date: 2026-01-31
tags: ['新機能', 'bash', 'パーミッション']
---

## 原文（日本語に翻訳）

追加 wildcard pattern matching for Bash tool permissions using `*` at any position in rules (e.g., `Bash(npm *)`, `Bash(* install)`, `Bash(git * main)`)
