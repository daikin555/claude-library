---
title: "改善 terminal rendering performance when using native insta..."
date: 2026-01-31
tags: ['改善']
---
...
改善 terminal rendering performance when using native installer or Bun, especially for text with emoji, ANSI codes, and Unicode characters
