---
title: "追加 `context_window.used_percentage` and `context_window.r..."
date: 2026-01-13
tags: ['新機能']
---
...
追加 `context_window.used_percentage` and `context_window.remaining_percentage` fields to status line input for easier context window display
