---
title: "修正 `@`-mention menu folder click behavior to navigate int..."
date: 2026-01-20
tags: ['バグ修正']
---
...
修正 `@`-mention menu folder click behavior to navigate into directories instead of selecting them
