---
title: "追加 slash command autocomplete support when `/` appears an..."
date: 2026-01-31
tags: ['新機能', 'コマンド']
---
...
追加 slash command autocomplete support when `/` appears anywhere in input, not just at the beginning
