---
title: "修正 corrupted config backup files accumulating in the home..."
date: 2026-01-13
tags: ['バグ修正']
---
...
修正 corrupted config backup files accumulating in the home directory (now only one backup is created per config file)
