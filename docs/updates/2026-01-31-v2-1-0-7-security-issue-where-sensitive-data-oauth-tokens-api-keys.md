---
title: "修正 security issue where sensitive data (OAuth tokens, API..."
date: 2026-01-31
tags: ['バグ修正']
---
...
修正 security issue where sensitive data (OAuth tokens, API keys, passwords) could be exposed in debug logs
