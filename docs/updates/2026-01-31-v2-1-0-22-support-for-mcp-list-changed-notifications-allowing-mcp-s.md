---
title: "追加 support for MCP `list_changed` notifications, allowing..."
date: 2026-01-31
tags: ['新機能', 'MCP']
---
...
追加 support for MCP `list_changed` notifications, allowing MCP servers to dynamically update their available tools, prompts, and resources without requiring reconnection
