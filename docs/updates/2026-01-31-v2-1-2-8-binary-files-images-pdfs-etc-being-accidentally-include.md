---
title: "修正 binary files (images, PDFs, etc.) being accidentally i..."
date: 2026-01-09
tags: ['バグ修正']
---
...
修正 binary files (images, PDFs, etc.) being accidentally included in memory when using `@include` directives in CLAUDE.md files
