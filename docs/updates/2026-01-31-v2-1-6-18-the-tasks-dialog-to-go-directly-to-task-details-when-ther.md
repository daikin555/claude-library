---
title: "改善 the `/tasks` dialog to go directly to task details whe..."
date: 2026-01-13
tags: ['改善']
---
...
改善 the `/tasks` dialog to go directly to task details when there's only one background task running
