---
title: "追加 automatic discovery of skills from nested `.claude/ski..."
date: 2026-01-13
tags: ['新機能']
---
...
追加 automatic discovery of skills from nested `.claude/skills` directories when working with files in subdirectories
