---
title: "修正 false skill duplicate detection on filesystems with la..."
date: 2026-01-09
tags: ['バグ修正']
---
...
修正 false skill duplicate detection on filesystems with large inodes (e.g., ExFAT) by using 64-bit precision for inode values
