---
title: "修正 Esc key with queued prompts to only move them to input..."
date: 2026-01-07
tags: ['バグ修正']
---
...
修正 Esc key with queued prompts to only move them to input without canceling the running task
